...
const FoundersEditor = ({
  ...
  const updateField = (key: keyof FoundersData, value: any) =>
    onChange({ ...data, [key]: value });

  const updateFounder = (
    idx: number,
    key: keyof FounderItem,
    value: string,
  ) => {
        ...
        <TabsContent value="founders-content" className="mt-4">
          <Card className="bg-card/80 border-border/70">
            <CardHeader>
              ...
              <CardDescription>
                Eyebrow, title, description, and CTA for the founders spotlight.
              </CardDescription>
            </CardHeader>
          ...
          <Card className="bg-card/80 border-border/70">
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Cards shown in the founders spotlight section.
                </CardDescription>
              </div>
            </CardHeader>
                ...
                >
                  ...
                  <div>
                    ...
                    <Input
                      value={founder.era}
                      onChange={(e) =>
                        updateFounder(idx, "era", e.target.value as any)
                      }
                  ...
                  <div className="md:col-span-2">
                    ...
                    <Input
                      value={founder.focus}
                      onChange={(e) =>
                        updateFounder(idx, "focus", e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateFounder(idx, "highlight", e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <Input
                      value={founder.href || ""}
                      onChange={(e) =>
                        updateFounder(idx, "href", e.target.value)
                      }
        ...
        <TabsContent value="founders-preview" className="mt-4">
          <Card className="bg-card/70 border-border/60">
            <CardHeader>
              ...
              <CardDescription>
                Static preview of the founders spotlight.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-3">
        ...
        <TabsContent value="founders-actions" className="mt-4">
          <Card className="bg-card/80 border-border/70">
            <CardHeader>
              ...
              <CardDescription>
                Restore defaults or publish founders changes.
              </CardDescription>
            </CardHeader>
