...
const SellerEditor = ({
  ...
  const updateField = (key: keyof SellersData, value: any) =>
        ...
        <TabsContent value="sellers-content" className="mt-4">
          <Card className="bg-card/80 border-border/70">
            <CardHeader>
              ...
              <CardDescription>
                Eyebrow, title, and description for the sellers section.
              </CardDescription>
            </CardHeader>
          ...
          <Card className="bg-card/80 border-border/70">
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Testimonials displayed in the seller signals section.
                </CardDescription>
              </div>
            </CardHeader>
                ...
                >
                  <div>
                    ...
                    <Input
                      value={seller.name}
                      onChange={(e) =>
                        updateSeller(idx, "name", e.target.value)
                      }
                      placeholder="Name"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      value={seller.role}
                      onChange={(e) =>
                        updateSeller(idx, "role", e.target.value)
                      }
                      placeholder="Founder"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateSeller(idx, "company", e.target.value)
                      }
                  ...
                  <div className="md:col-span-2">
                    ...
                    <Input
                      value={seller.quote}
                      onChange={(e) =>
                        updateSeller(idx, "quote", e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateSeller(idx, "outcome", e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <Input
                      value={seller.image}
                      onChange={(e) =>
                        updateSeller(idx, "image", e.target.value)
                      }
                      placeholder="https://..."
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      value={seller.href || ""}
                      onChange={(e) =>
                        updateSeller(idx, "href", e.target.value)
                      }
                      placeholder="/gallery"
                    />
                  </div>
        ...
        <TabsContent value="sellers-preview" className="mt-4">
          <Card className="bg-card/70 border-border/60">
            <CardHeader>
              ...
              <CardDescription>
                Static preview of the seller signals.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-3">
        ...
        <TabsContent value="sellers-actions" className="mt-4">
          <Card className="bg-card/80 border-border/70">
            <CardHeader>
              ...
              <CardDescription>
                Restore defaults or publish seller updates.
              </CardDescription>
            </CardHeader>
