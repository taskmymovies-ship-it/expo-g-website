...
const CoFoundersEditor = ({
  ...
  const updateField = (key: keyof CoFoundersData, value: any) =>
    onChange({ ...data, [key]: value });

  const updateCofounder = (
    idx: number,
    key: keyof CoFounderItem,
    value: string,
  ) => {
        ...
        <TabsContent value="cofounders-content" className="mt-4">
          <Card className="bg-card/80 border-border/70">
            <CardHeader>
              ...
              <CardDescription>
                Eyebrow, title, description, and CTA for the co-founders
                spotlight.
              </CardDescription>
            </CardHeader>
          ...
          <Card className="bg-card/80 border-border/70">
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Cards shown in the co-founders spotlight section.
                </CardDescription>
              </div>
            </CardHeader>
                ...
                >
                  <div>
                    ...
                    <Input
                      value={cf.name}
                      onChange={(e) =>
                        updateCofounder(idx, "name", e.target.value)
                      }
                      placeholder="Name"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      value={cf.track}
                      onChange={(e) =>
                        updateCofounder(idx, "track", e.target.value as any)
                      }
                  ...
                  <div>
                    ...
                    <Input
                      value={cf.title}
                      onChange={(e) =>
                        updateCofounder(idx, "title", e.target.value)
                      }
                  ...
                  <div className="md:col-span-2">
                    ...
                    <Input
                      value={cf.focus}
                      onChange={(e) =>
                        updateCofounder(idx, "focus", e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <Input
                      value={cf.image}
                      onChange={(e) =>
                        updateCofounder(idx, "image", e.target.value)
                      }
                      placeholder="https://..."
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      value={cf.highlight}
                      onChange={(e) =>
                        updateCofounder(idx, "highlight", e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <Input
                      value={cf.href || ""}
                      onChange={(e) =>
                        updateCofounder(idx, "href", e.target.value)
                      }
                      placeholder="/about#team"
                    />
                  </div>
        ...
        <TabsContent value="cofounders-preview" className="mt-4">
          <Card className="bg-card/70 border-border/60">
            <CardHeader>
              ...
              <CardDescription>
                Static preview of the co-founders spotlight.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-3">
        ...
        <TabsContent value="cofounders-actions" className="mt-4">
          <Card className="bg-card/80 border-border/70">
            <CardHeader>
              ...
              <CardDescription>
                Restore defaults or publish co-founder changes.
              </CardDescription>
            </CardHeader>
