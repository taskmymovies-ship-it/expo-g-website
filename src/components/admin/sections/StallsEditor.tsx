...
const StallsEditor = ({
  ...
  const updateField = (key: keyof StallsData, value: any) =>
        ...
        <TabsContent value="stalls-content" className="mt-4">
          <Card className="bg-card/80 border-border/70">
            <CardHeader>
              ...
              <CardDescription>
                Eyebrow, title, description, stats, and CTA for the stalls
                mosaic.
              </CardDescription>
            </CardHeader>
          ...
          <Card className="bg-card/80 border-border/70">
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Images shown in the stalls parallax mosaic.
                </CardDescription>
              </div>
            </CardHeader>
            <CardContent className="space-y-3">
        ...
        <TabsContent value="stalls-preview" className="mt-4">
          <Card className="bg-card/70 border-border/60">
            <CardHeader>
              ...
              <CardDescription>
                Static preview of the stalls mosaic.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-3">
        ...
        <TabsContent value="stalls-actions" className="mt-4">
          <Card className="bg-card/80 border-border/70">
            <CardHeader>
              ...
              <CardDescription>
                Restore defaults or publish stalls changes.
              </CardDescription>
            </CardHeader>
