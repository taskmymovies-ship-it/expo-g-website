...
const CelebEditor = ({
  ...
  const updateField = (key: keyof CelebData, value: any) =>
        ...
        <TabsContent value="celeb-content" className="mt-4">
          <Card className="bg-card/80 border-border/70">
            <CardHeader>
              ...
              <CardDescription>
                Eyebrow, title, and description for the celebrity section.
              </CardDescription>
            </CardHeader>
          ...
          <Card className="bg-card/80 border-border/70">
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Cards shown in the celebrity spotlight section.
                </CardDescription>
              </div>
            </CardHeader>
                ...
                >
                  ...
                  <div>
                    ...
                    <Input
                      value={celeb.title}
                      onChange={(e) =>
                        updateCeleb(idx, "title", e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <Input
                      value={celeb.badge}
                      onChange={(e) =>
                        updateCeleb(idx, "badge", e.target.value)
                      }
                  ...
                  <div className="md:col-span-2">
                    ...
                    <Input
                      value={celeb.quote}
                      onChange={(e) =>
                        updateCeleb(idx, "quote", e.target.value)
                      }
                      placeholder="Quote"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      value={celeb.image}
                      onChange={(e) =>
                        updateCeleb(idx, "image", e.target.value)
                      }
                      placeholder="https://..."
                    />
                  </div>
        ...
        <TabsContent value="celeb-preview" className="mt-4">
          <Card className="bg-card/70 border-border/60">
            <CardHeader>
              ...
              <CardDescription>
                Static preview of the celebrity spotlight.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-3">
                  ...
                  >
                    ...
                    <div className="p-3 space-y-1">
                      <div className="flex items-center justify-between text-sm font-semibold">
                        ...
                        {celeb.badge && (
                          <Badge variant="secondary">{celeb.badge}</Badge>
                        )}
                      </div>
        ...
        <TabsContent value="celeb-actions" className="mt-4">
          <Card className="bg-card/80 border-border/70">
            <CardHeader>
              ...
              <CardDescription>
                Restore defaults or publish changes for celebrity spotlight.
              </CardDescription>
            </CardHeader>
