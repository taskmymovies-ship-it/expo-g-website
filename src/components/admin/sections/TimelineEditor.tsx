...
const TimelineEditor = ({
  ...
  const updateField = (key: keyof TimelineData, value: any) =>
    ...
    <div id="timeline" className="pt-10 space-y-4">
      <div className="text-center space-y-2">
        ...
        <p className="text-muted-foreground text-sm">
          Manage the “30 Years History / Journey Timeline (Legacy in Motion)”
          section content.
        </p>
      </div>
        ...
        <TabsContent value="timeline-content" className="mt-4">
          <Card className="bg-card/80 border-border/70">
            <CardHeader>
              ...
              <CardDescription>
                Eyebrow, title, and description for the timeline intro block.
              </CardDescription>
            </CardHeader>
          ...
          <Card className="bg-card/80 border-border/70">
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Items shown in the sticky scroll timeline.
                </CardDescription>
              </div>
            </CardHeader>
                ...
                >
                  ...
                  <div className="md:col-span-3">
                    ...
                    <Input
                      value={item.image || ""}
                      onChange={(e) =>
                        updateMilestone(idx, "image", e.target.value)
                      }
                      placeholder="https://..."
                    />
                  </div>
        ...
        <TabsContent value="timeline-preview" className="mt-4">
          <Card className="bg-card/70 border-border/60">
            <CardHeader>
              ...
              <CardDescription>
                Static preview of the timeline cards.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-3">
        ...
        <TabsContent value="timeline-actions" className="mt-4">
          <Card className="bg-card/80 border-border/70">
            <CardHeader>
              ...
              <CardDescription>
                Restore defaults or publish timeline changes.
              </CardDescription>
            </CardHeader>
