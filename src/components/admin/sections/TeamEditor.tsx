    ...
    <div id="team" className="pt-10 space-y-4">
      <div className="text-center space-y-2">
        ...
        <p className="text-muted-foreground text-sm">
          Manage the home-page team spotlight (eyebrow, copy, CTA, and members
          list).
        </p>
      </div>
        ...
        <TabsContent value="team-content" className="mt-4">
          <Card className="bg-card/80 border-border/70">
            <CardHeader>
              ...
              <CardDescription>
                Eyebrow, title, description, and CTA for the team block.
              </CardDescription>
            </CardHeader>
          ...
          <Card className="bg-card/80 border-border/70">
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>
                  People cards displayed on the home page.
                </CardDescription>
              </div>
            </CardHeader>
                ...
                >
                  ...
                  <div>
                    ...
                    <Input
                      value={member.focus || ""}
                      onChange={(e) =>
                        updateMember(idx, "focus", e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <Input
                      value={member.image}
                      onChange={(e) =>
                        updateMember(idx, "image", e.target.value)
                      }
                      placeholder="https://..."
                    />
                  </div>
                  <div>
                    <label className="text-xs text-muted-foreground mb-1 block">
                      Profile href (optional)
                    </label>
                    <Input
                      value={member.href || ""}
                      onChange={(e) =>
                        updateMember(idx, "href", e.target.value)
                      }
        ...
        <TabsContent value="team-preview" className="mt-4">
          <Card className="bg-card/70 border-border/60">
            <CardHeader>
              ...
              <CardDescription>
                Static preview of the team spotlight.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-3">
        ...
        <TabsContent value="team-actions" className="mt-4">
          <Card className="bg-card/80 border-border/70">
            <CardHeader>
              ...
              <CardDescription>
                Restore defaults or publish changes for the team section.
              </CardDescription>
            </CardHeader>
