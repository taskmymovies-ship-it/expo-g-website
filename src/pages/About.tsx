...
const About = () => {
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
          ...
          >
            <div className="rounded-3xl border border-border/60 bg-card/70 p-6 shadow-2xl shadow-primary/10 backdrop-blur-xl space-y-4">
              {about.platforms.map((card) => (
                <div
                  key={card.title}
                  className="rounded-2xl border border-border/60 bg-card/80 p-5 space-y-2"
                >
      ...
      <StatsStrip
        stats={stats}
        className="bg-card/40 border-y border-border/70"
      />
        ...
        <div className="container-custom grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-1 space-y-4">
            ...
            <p className="text-muted-foreground">
              Every edition blends production, technology, and operations into a
              single playbook that travels with us.
            </p>
          </div>
      ...
      <section className="section-padding bg-card/40 border-y border-border/60">
        <div className="container-custom space-y-8">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
            ...
            <Button asChild variant="outline">
              <Link to={about.partners.cta.href || "/brands"}>
                {about.partners.cta.label || "View a partner story"}
              </Link>
            </Button>
          </div>
        ...
        <div className="container-custom grid md:grid-cols-2 gap-8 items-center">
          <div className="space-y-3">
            ...
            <div className="flex gap-3">
              <Button asChild variant="hero">
                <Link to={about.work.primaryCta.href}>
                  {about.work.primaryCta.label}
                </Link>
              </Button>
              <Button asChild variant="outline">
                <Link to={about.work.secondaryCta.href}>
                  {about.work.secondaryCta.label}
                </Link>
              </Button>
            </div>
          </div>
